  ...
  <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="p-0 h-full flex flex-col">
      ...
      <div class="flex items-center justify-center p-4 cursor-pointer" @click="jumpToIndexPage">
        ...
        <span class="text-2xl font-bold font-sans tracking-wide text-gray-800">简历优化助手</span>
      </div>
      ...
      <ul class="px-3 text-gray-600 mb-2">
        <li class="flex items-center py-1 px-2 hover:bg-gray-100 rounded-lg cursor-pointer" @click="jumpToResumeOptimizePage">
          <SvgIcon name="resume-optimize" customCss="w-5 h-5 mr-2 inline mb-0" />
          <span>简历优化助手</span>
        </li>
      </ul>
...
// 跳转简历优化助手
const jumpToResumeOptimizePage = () => {

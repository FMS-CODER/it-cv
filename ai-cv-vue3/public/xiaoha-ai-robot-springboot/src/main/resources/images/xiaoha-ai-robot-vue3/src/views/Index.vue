        ...
        <div class="max-w-3xl w-full">
          <div class="text-center mb-10">
            <div class="flex items-center justify-center mb-3">
              ...
              <h2 class="text-2xl text-gray-800">简历优化助手，很高兴见到你！</h2>
            </div>
            <p class="text-gray-500">我可以帮你优化简历、提供面试指导、职业建议，助你职场之路更顺畅~</p>
          </div>
          ...
          <!-- 快速入口 -->
          <div class="mt-8">
            <h3 class="text-gray-600 text-sm mb-3 text-center">开始优化你的简历</h3>
            <div class="flex justify-center">
              <div @click="goToResumeOptimize" class="p-4 bg-gradient-to-br from-green-50 to-teal-50 rounded-xl cursor-pointer hover:from-green-100 hover:to-teal-100 transition-all border border-green-100 flex-1 max-w-xs">
                <div class="flex items-center gap-2 mb-2">
                  <SvgIcon name="resume-optimize" customCss="w-5 h-5 text-green-600" />
                  <span class="font-semibold text-gray-800">简历优化助手</span>
                </div>
                <p class="text-xs text-gray-500">简历优化、面试指导、职场建议</p>
              </div>
            </div>
          </div>
...
const goToResumeOptimize = () => {
  router.push({ name: 'ResumeOptimizePage' })
}
